...
begin
  ...
  GridCoef.Cells[1,0] := Copy(EdiF1.Text,Pos('x',EdiF1.Text)+1,(Pos('y',EdiF1.Text)-1)-(Pos('x',EdiF1.Text)+1));
  GridCoef.Cells[2,0] := Copy(EdiF1.Text,Pos('y',EdiF1.Text)+1,(Pos('z',EdiF1.Text)-1)-(Pos('y',EdiF1.Text)+1));

  GridCoef.Cells[0,1] := Copy(EdiF2.Text,0,Pos('x',EdiF2.Text)-1);
  GridCoef.Cells[1,1] := Copy(EdiF2.Text,Pos('x',EdiF2.Text)+1,(Pos('y',EdiF2.Text)-1)-(Pos('x',EdiF2.Text)+1));
  GridCoef.Cells[2,1] := Copy(EdiF2.Text,Pos('y',EdiF2.Text)+1,(Pos('z',EdiF2.Text)-1)-(Pos('y',EdiF2.Text)+1));

  GridCoef.Cells[0,2] := Copy(EdiF3.Text,0,Pos('x',EdiF3.Text)-1);
  GridCoef.Cells[1,2] := Copy(EdiF3.Text,Pos('x',EdiF3.Text)+1,(Pos('y',EdiF3.Text)-1)-(Pos('x',EdiF3.Text)+1));
  GridCoef.Cells[2,2] := Copy(EdiF3.Text,Pos('y',EdiF3.Text)+1,(Pos('z',EdiF3.Text)-1)-(Pos('y',EdiF3.Text)+1));
