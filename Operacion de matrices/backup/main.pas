...
begin
  ...
  begin
    ...
    begin
      if ( c1 = 3 ) then
      begin
        MatrizResult.Cells[0,0] := FloatToStr(  (StrToFloat(Matriz1.Cells[1,1])*StrToFloat(Matriz1.Cells[2,2]))-(StrToFloat(Matriz1.Cells[2,1])*StrToFloat(Matriz1.Cells[1,2])) );
        MatrizResult.Cells[0,1] := FloatToStr( -((StrToFloat(Matriz1.Cells[0,1])*StrToFloat(Matriz1.Cells[2,2]))-(StrToFloat(Matriz1.Cells[2,1])*StrToFloat(Matriz1.Cells[0,2]))) );
        MatrizResult.Cells[0,2] := FloatToStr(  (StrToFloat(Matriz1.Cells[0,1])*StrToFloat(Matriz1.Cells[1,2]))-(StrToFloat(Matriz1.Cells[1,1])*StrToFloat(Matriz1.Cells[0,2])) );
        MatrizResult.Cells[1,0] := FloatToStr( -((StrToFloat(Matriz1.Cells[1,0])*StrToFloat(Matriz1.Cells[2,2]))-(StrToFloat(Matriz1.Cells[2,0])*StrToFloat(Matriz1.Cells[1,2]))) );
        MatrizResult.Cells[1,1] := FloatToStr(  (StrToFloat(Matriz1.Cells[0,0])*StrToFloat(Matriz1.Cells[2,2]))-(StrToFloat(Matriz1.Cells[2,0])*StrToFloat(Matriz1.Cells[0,2])) );
        MatrizResult.Cells[1,2] := FloatToStr( -((StrToFloat(Matriz1.Cells[0,0])*StrToFloat(Matriz1.Cells[1,2]))-(StrToFloat(Matriz1.Cells[1,0])*StrToFloat(Matriz1.Cells[0,2]))) );
        MatrizResult.Cells[2,0] := FloatToStr(  (StrToFloat(Matriz1.Cells[1,0])*StrToFloat(Matriz1.Cells[2,1]))-(StrToFloat(Matriz1.Cells[2,0])*StrToFloat(Matriz1.Cells[1,1])) );
        MatrizResult.Cells[2,1] := FloatToStr( -((StrToFloat(Matriz1.Cells[0,0])*StrToFloat(Matriz1.Cells[2,1]))-(StrToFloat(Matriz1.Cells[2,0])*StrToFloat(Matriz1.Cells[0,1]))) );
        MatrizResult.Cells[2,2] := FloatToStr(  (StrToFloat(Matriz1.Cells[0,0])*StrToFloat(Matriz1.Cells[1,1]))-(StrToFloat(Matriz1.Cells[1,0])*StrToFloat(Matriz1.Cells[0,1])) );
